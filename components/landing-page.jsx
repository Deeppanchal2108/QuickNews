        ...
        <div className="min-h-screen font-sans bg-gray-50">
            ...
            <motion.section className="py-16 px-4 bg-gray-100" {...fadeInUp}>
                <div className="max-w-6xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-12 text-gray-900">How QuickNews Works</h2>
            ...
            <motion.section ref={statsRef} className="py-20 px-4 bg-white" {...fadeInUp}>
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-3xl font-bold mb-12 text-center text-gray-900">Why People Choose QuickNews</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <p className="text-gray-700">faster news consumption with QuickNews</p>
                        </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-700 mb-8">
                                The average person spends 70 minutes daily reading news. With QuickNews, get the same information in
                                just 12 minutes.
                            </p>
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <div className="flex items-start space-x-4 p-4 bg-red-800 text-white rounded-lg">
                                    ...
                                    <div>
                                        <h4 className="font-medium">QuickNews</h4>
                                        <p className="text-sm">
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <div className="space-y-8 ml-8">
                                {[
                                    { time: "Just now", title: "SpaceX launches new satellite", category: "Technology", dotColor: "bg-red-700" },
                                    { time: "2 hours ago", title: "Global markets react to economic data", category: "Business", dotColor: "bg-red-600" },
                                    { time: "5 hours ago", title: "New healthcare bill passes senate vote", category: "Politics", dotColor: "bg-red-500" },
                                    { time: "Yesterday", title: "Scientists discover potential new treatment", category: "Science", dotColor: "bg-red-400" },
                                ].map((item, index) => (
                                    <motion.div
                                        key={index}
                                        className="relative"
